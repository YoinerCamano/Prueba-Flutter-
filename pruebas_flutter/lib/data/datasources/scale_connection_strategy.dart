...
class TruTestS3Strategy extends ScaleConnectionStrategy {
  ...
  Future<void> initialize({
    ...
    // S3 soporta secuencia completa: {ZN} → {ZA1} → {SPWU}
...
class EziWeigh7Strategy extends ScaleConnectionStrategy {
  ...
  Future<void> initialize({
    ...
    // EziWeigh7 no soporta {ZN} ni {SPWU}
    // La activación de ACK ({ZA1}) y consultas extra se manejan desde el bloc
    print('🔧 EziWeigh7: Sin secuencia de unidades, directo a peso');
